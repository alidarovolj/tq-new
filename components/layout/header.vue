  ...
  <header class="bg-white">
    ...
    >
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end gap-3 items-center">
        ...
        <div v-else-if="user.userProfile" class="flex items-center gap-3">
    ...
    <nav
      aria-label="Global"
      class="mx-auto flex container px-4 md:px-0 items-center justify-between py-6"
    >
      ...
      >
        <div class="flex items-center justify-between">
          <a class="-m-1.5 p-1.5" href="#">
            <img alt="" class="h-8 w-auto" src="@/assets/img/logos/main.png" />
          </a>
          <button
        ...
        <div class="mt-6 flow-root">
          <div
            class="-my-6 divide-y divide-gray-500/10 flex flex-col justify-between h-full"
          >
