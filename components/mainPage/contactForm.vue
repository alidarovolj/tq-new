...
const sendForm = async () => {
  ...
  try {
    ...
    notifications.showNotification(
      "success",
      "Успешно",
      "Вы успешно отправили сообщение, мы свяжемся с вами в ближайшее время."
    );
    form.value = {
      email: "",
      name: "",
        ...
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
            ...
            <div class="flex gap-x-4">
              <dt class="flex-none">
                <span class="sr-only">{{
                  $t("contact_form.icons.phone")
                }}</span>
                <PhoneIcon aria-hidden="true" class="h-7 w-6 text-gray-400" />
              </dt>
              <dd>
                <a class="hover:text-gray-900" href="tel:+77714142525"
                  >{{ $t("contact_form.phone") }}: +7 (771) 414-25-25</a
                >
              </dd>
            </div>
            <div class="flex gap-x-4">
          ...
          <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            <div>
              <label
                ...
                for="first-name"
                >{{ $t("contact_form.fields.name") }}</label
              >
              <div class="mt-2.5">
                <input
                  id="first-name"
            ...
            <div class="sm:col-span-2">
              <label
                class="block text-sm font-semibold leading-6 text-gray-900"
                for="message"
                >{{ $t("contact_form.fields.message") }}</label
              >
              <div class="mt-2.5">
                <textarea
                  id="message"
