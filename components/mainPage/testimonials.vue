      ...
      <div
        ...
        <div class="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
          <div class="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
            <img class="absolute inset-0 h-full w-full rounded-2xl bg-gray-800 object-cover object-center shadow-2xl"
                 src="@/assets/img/kolesa.png" alt=""/>
          </div>
        </div>
        <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
          <figure class="relative isolate pt-6 sm:pt-12">
            ...
            <blockquote class="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
              <p>TQ компания предлагает широкий ассортимент фар от Kolesa Group, что делает их надежным выбором для
                автомобильных владельцев. Сервис компании на высоком уровне: быстрая доставка, качественная консультация
                и поддержка.</p>
            </blockquote>
            <figcaption class="mt-8 text-base">
              <div class="font-semibold text-white">Dmitriy Botanov</div>
              <div class="mt-1 text-gray-400">CEO компании Kolesa Group</div>
            </figcaption>
          </figure>
        </div>
      </div>
