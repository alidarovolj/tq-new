...
watch(() => store.notification.show, (newVal) => {
  if (newVal) {
    startProgress();
  } else {
    clearInterval(progressInterval);
...
<template>
  <div v-if="store.notification.show" aria-live="assertive"
          ...
          <div class="p-4">
            <div class="flex items-start">
              ...
              <div class="ml-3 w-0 flex-1 pt-0.5">
                ...
                <p class="mt-1 text-sm text-gray-500">{{ store.notification.message }}</p>
              </div>
