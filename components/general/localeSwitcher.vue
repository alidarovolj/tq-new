  ...
  <client-only>
    <Menu
      ...
      <transition
        ...
        <MenuItems
            class="absolute top-full right-0 sm:left-0 z-[1000] mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div class="py-1">
            <MenuItem
