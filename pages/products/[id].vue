...
const faqs = [
  {
    question: 'В каком формате представлены эти иконки?',
    answer:
        'Иконки представлены в формате SVG (масштабируемая векторная графика). Их можно импортировать в выбранный вами инструмент для дизайна и использовать непосредственно в коде.',
  },
  {
    question: 'Можно ли использовать иконки в разных размерах?',
    answer:
        "Да. Иконки созданы на сетке 24 x 24 пикселя, но их можно масштабировать до разных размеров по мере необходимости. Мы не рекомендуем использовать размеры меньше 20 x 20 или больше 64 x 64 пикселя, чтобы сохранить читаемость и визуальный баланс.",
  },
...
const license = {
  href: '#',
  summary:
      'Для личного и профессионального использования. Вы не можете перепродавать или распространять эти иконки в их оригинальном или измененном виде.',
  content: `
    <h4>Обзор</h4>

    <p>Для личного и профессионального использования. Вы не можете перепродавать или распространять эти иконки в их оригинальном или измененном виде.</p>

    <ul role="list">
    <li>Вы можете использовать иконки в неограниченном количестве проектов.</li>
    <li>Для использования иконок не требуется указание авторства.</li>
    </ul>

    <h4>Что вы можете делать с этим</h4>

    <ul role="list">
    <li>Используйте их свободно в своей личной и профессиональной работе.</li>
    <li>Сделайте их своими. Измените цвета, чтобы соответствовать вашему проекту или бренду.</li>
    </ul>

    <h4>Что нельзя делать с этим</h4>

    <ul role="list">
    <li>Не будьте жадными. Продажа или распространение этих иконок в их оригинальном или измененном виде запрещена.</li>
    <li>Не будьте злыми. Эти иконки нельзя использовать на веб-сайтах или в приложениях, которые продвигают незаконные или аморальные убеждения или действия.</li>
    </ul>
  `,
}
      ...
      <div
        ...
        <div class="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
          ...
          <div class="mt-10 border-t border-gray-200 pt-10">
            <h3 class="text-sm font-medium text-gray-900">Основные моменты</h3>
