...
const isDisabledPhone = computed(
  () =>
    !!user.userProfile &&
    !!user.userProfile.data &&
    !!user.userProfile.data.phone
);
...
const makeCheckout = async () => {
  ...
  try {
    ...
    notifications.showNotification(
      "success",
      t("notification.success_title"),
      t("notification.success_message")
    );
    await nextTick();
    if (token.value) {
                ...
                <div class="flex flex-col gap-3 justify-between mb-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      name="address"
                      :placeholder="
                        $t('checkout.second.delivery_type_placeholder')
                      "
                      type="text"
                    />
                  </div>
                  ...
                  <YandexMap
                    @send_data="
                      (data) => (form.delivery_address = data.address)
                    "
                  />

                  <!-- City and Address Inputs -->
                  <div
                    class="grid grid-cols-1 sm:gap-y-4 sm:grid-cols-2 gap-x-4 xl:grid-cols-3"
                  >
                    ...
                    <div class="mb-4">
                      ...
                      <input
                        ...
                        :class="{
                          'border-red-500': v$.delivery_address.$error,
                        }"
                        :placeholder="
                          $t('addresses.create.address_placeholder')
                        "
                        class="py-2 px-4 border border-[#F0DFDF] rounded-lg w-full bg-white"
                        name="address"
                        type="text"
                    ...
                    <div class="mb-4">
                      ...
                      >
                        ...
                        <span class="text-gray-400">(необязательно)</span>
                      </label>
                      <input
                        id="entrance"
                        v-model="formAddress.entrance"
                        :placeholder="
                          $t('addresses.create.entrance_placeholder')
                        "
                        class="py-2 px-4 border border-[#F0DFDF] rounded-lg w-full bg-white"
                        name="entrance"
                        type="text"
                    ...
                    <div class="mb-4">
                      ...
                      <input
                        ...
                        :placeholder="
                          $t('addresses.create.apartment_placeholder')
                        "
                        class="py-2 px-4 border border-[#F0DFDF] rounded-lg w-full bg-white"
                        name="apartment"
                        type="text"
